...
export type SearchOrderQuery = { __typename?: 'Query', searchOrder: Array<{ __typename?: 'Order', id: string, createdAt: any, updatedAt?: any | null, totalPrice: number, status: OrderStatus, address: string, fullName: string, phone: string, payment: { __typename?: 'OrderPaymentEmbeddable', provider: PaymentProvider }, orderItems: Array<{ __typename?: 'OrderItem', hasLab: boolean, id: string, labPrice: number, productPrice: number, quantity: number, product: { __typename?: 'Product', id: string, name: string, price: number, images: Array<{ __typename?: 'ProductImage', url: string }>, lab?: { __typename?: 'ProductLab', price: number } | null } }> }> };
