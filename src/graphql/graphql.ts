...
export type ExampleQQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;

export type ExampleQQuery = { __typename?: 'Query'; post?: { __typename?: 'Post'; title?: string | null } | null };
...
export const ExampleQDocument = new TypedDocumentString(`
    query ExampleQ($id: ID!) {
  post(id: $id) {
    title
  }
}
    `) as unknown as TypedDocumentString<ExampleQQuery, ExampleQQueryVariables>;
