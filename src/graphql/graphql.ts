...
export type GetProductQuery = { __typename?: 'Query', product: { __typename?: 'Product', description: string, id: string, name: string, price: number, rating: number, sold: number, categories: Array<{ __typename?: 'ProductCategory', id: string, name: string, type: CategoryType, title: string }>, images: Array<{ __typename?: 'ProductImage', id: string, url: string }>, feedbacks: Array<{ __typename?: 'Feedback', note: string, createdAt: any, id: string, rating: number, user: { __typename?: 'User', fullName: string } }>, lab?: { __typename?: 'ProductLab', price: number } | null }, products: { __typename?: 'ProductsWithPaginationResponse', items: Array<{ __typename?: 'Product', id: string, price: number, name: string, rating: number, images: Array<{ __typename?: 'ProductImage', url: string }>, feedbacks: Array<{ __typename?: 'Feedback', id: string }> }> } };
