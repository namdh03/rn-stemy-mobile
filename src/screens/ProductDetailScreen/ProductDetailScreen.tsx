...
const ProductDetailScreen = () => {
  return (
    <ScrollView
      contentContainerClassName='p-[24px] mx-auto w-full max-w-xl'
    ...
    >
      ...
      <View className='gap-[15px]'>
        ...
        <Text className='font-inter-regular text-foreground text-[14px] leading-[22px] tracking-[0.2px]'>
          ...
          dàng và thú vị. Các bạn có thể tự tay lắp ráp, điều khiển và lập trình các tính năng hấp dẫn của một chú Robot
          theo phương pháp giáo dục STEM hiện đại.
        </Text>
        <FlexibleImage
          source={{
        ...
        <Text className='font-inter-regular text-foreground text-[14px] leading-[22px] tracking-[0.2px]'>
          Đi kèm với Rover là sách hướng dẫn lập trình chi tiết bao gồm nhiều bài học có hình ảnh minh hoạ, code mẫu và
